...
build: ## Build the container
	docker build --platform $(PLATFORM) --build-arg="RUNNER_VERSION=${RUNNER_VERSION}" -t $(APP_NAME) .

build-nc: ## Build the container without caching
	docker build --platform $(PLATFORM) --build-arg="RUNNER_VERSION=${RUNNER_VERSION}" --no-cache -t $(APP_NAME) .
